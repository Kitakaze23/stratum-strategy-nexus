      ...
      <div className="grid gap-16 lg:grid-cols-12 lg:gap-12">
        <div className="lg:col-span-5">
          <SectionHead
            ...
            description="Опишите задачу, с которой вы столкнулись. После получения заявки я свяжусь с вами, чтобы уточнить детали и предложить наиболее подходящий формат консультации."
          />
          ...
          {sent ? (
            ...
            >
              ...
              <p className="mt-4 max-w-[460px] text-[0.9375rem] leading-[1.7] text-muted-foreground">
                Спасибо за обращение. Я свяжусь с вами в течение одного рабочего дня, чтобы уточнить
                детали и предложить подходящий формат консультации.
              </p>
              <button
                type="button"
