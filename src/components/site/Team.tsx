  ...
  return (
    <Section id="team" labelledBy="team-title">
      <SectionHead
        ...
        description="Stratum Consulting — небольшая практика senior-экспертов. Мы работали с цифровыми продуктами, аналитикой, AI и цифровизацией сложных промышленных систем — и оцениваем решения как практики, а не только как консультанты."
      />
