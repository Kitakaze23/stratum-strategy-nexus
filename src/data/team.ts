...
export const ACHIEVEMENTS = [
  {
    figure: "680 000+",
    label: "пользователей",
    text: "Платформа для которой мы готовили продуктовое решение для предпринимателей.",
  },
  {
    figure: "х2",
    label: "MAU продукта",
  ...
  },
  {
    ...
    text: "Помогли масштабировать команду, под задачи проекта, с 13 до 28 специалистов.",
  },
  {
    figure: "7 600+",
  ...
  {
    figure: "100+",
    label: "фичей выведено в production",
...
export const INDUSTRIAL_HIGHLIGHTS = [
  ...
  },
  {
    ...
    text: "Разработанные системы на основе данных и AI позволяют выявлять потенциально аварийные риски раньше традиционных методов, применявшихся на объектах.",
  },
  {
