...
export const EXPERTS: readonly Expert[] = [
  {
    ...
    primaryExpertise: {
      title: "Независимая оценка AI и цифровых решений в промышленности и энергетике",
      text: "Независимая оценка цифровых и AI-решений: от проверки ценности и логики решения до оценки рисков реализации и возможностей развития в сложных корпоративных и промышленных средах.",
    },
    tags: [],
    bio: [],
    experience: [],
